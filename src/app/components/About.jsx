          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              {Roles.map((role, index) => (
                <span key={index} className="px-4 py-2 bg-gray-900/50 border border-gray-400 text-gray-300 hover:bg-gray-800 hover:border-gray-400 text-lg rounded-lg">
                  {role}
                </span>
              ))}
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-3">
                {Skills.map((skill, index) => (
                  <span
                    key={index}
                    className="px-4 py-2 bg-gray-900/50 border border-gray-400 text-gray-300 hover:bg-gray-800 hover:border-gray-400 text-sm rounded-lg"
                  >
                    {skill}
                  </span>
                ))}
